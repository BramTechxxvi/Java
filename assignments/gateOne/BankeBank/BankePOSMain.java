...
public class BankePOSMain {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            case 1: print("Create an account......."); continue;
            case 2: while (true) {
                print(getBankServices());
                try {
                    bankServices = Integer.parseInt(input("Select an Option: "));
                    if (bankServices < 1 || bankServices > 7) throw new Exception("Invalid option... Try again");
                } catch (Exception e) {
                    print("Invalid option... Try again");continue;
                } switch (bankServices) {
                    case 1: System.out.print("Deposit money......"); continue;
                    case 2: System.out.print("Withdraw money......"); continue;
                    case 3: print("Check account balance......"); continue;
                    case 4: print("Transfer money......"); continue;
                    case 5: print("Close account ......"); continue;
                    case 6: print("Change Pin ......"); continue;
                    case 7: print("Exiting...");
                } break;
            }
            case 3: print("Thank You For Banking With Us"); break;
            } break;
        }
    }
